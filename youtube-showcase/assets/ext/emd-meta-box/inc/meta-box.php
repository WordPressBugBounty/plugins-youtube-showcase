...
if ( ! class_exists( 'EMD_Meta_Box' ) )
{
	...
	class EMD_Meta_Box
	{
		...
		{
			$jqvalid_msg['required'] = __('This field is required.','youtube-showcase');
			$jqvalid_msg['remote'] = __('Please fix this field.','youtube-showcase');
			$jqvalid_msg['email'] = __('Please enter a valid email address.','youtube-showcase');
			$jqvalid_msg['url'] = __('Please enter a valid URL.','youtube-showcase');
			$jqvalid_msg['date'] = __('Please enter a valid date.','youtube-showcase');
			$jqvalid_msg['dateISO'] = __('Please enter a valid date ( ISO )','youtube-showcase');
			$jqvalid_msg['number'] = __('Please enter a valid number.','youtube-showcase');
			$jqvalid_msg['digits']= __('Please enter only digits.','youtube-showcase');
			$jqvalid_msg['creditcard']= __('Please enter a valid credit card number.','youtube-showcase');
			$jqvalid_msg['equalTo']= __('Please enter the same value again.','youtube-showcase');
			$jqvalid_msg['maxlength']= __('Please enter no more than {0} characters.','youtube-showcase');
			$jqvalid_msg['minlength']= __('Please enter at least {0} characters.','youtube-showcase');
			$jqvalid_msg['rangelength']= __('Please enter a value between {0} and {1} characters long.','youtube-showcase');
			$jqvalid_msg['range']= __('Please enter a value between {0} and {1}.','youtube-showcase');
			$jqvalid_msg['max']= __('Please enter a value less than or equal to {0}.','youtube-showcase');
			$jqvalid_msg['min']= __('Please enter a value greater than or equal to {0}.','youtube-showcase');
