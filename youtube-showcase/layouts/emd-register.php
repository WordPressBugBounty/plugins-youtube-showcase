...
<label for="emd_user_login"><span><?php esc_html_e('Username', 'youtube-showcase' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Username field is required','youtube-showcase');?>" id="req_user_login" class="helptip">
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-email"><span><?php esc_html_e('Email', 'youtube-showcase' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Email field is required','youtube-showcase');?>" id="req_user_login" class="helptip">
<span class="field-icons required" aria-required="true"></span></a>
</span>
</label>
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-fname"><span><?php esc_html_e('First Name', 'youtube-showcase' ); ?></span>
</label>
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-lname"><span><?php esc_html_e('Last Name', 'youtube-showcase' ); ?></span>
</label>
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-pass"><span><?php esc_html_e('Password', 'youtube-showcase' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Password field is required','youtube-showcase');?>" id="req_user_login" class="helptip">
<span class="field-icons required" aria-required="true"></span></a>
</span>
</label>
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-pass2"><span><?php esc_html_e('Confirm Password', 'youtube-showcase' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Confirm Password field is required','youtube-showcase');?>" id="req_user_login" class="helptip">
<span class="field-icons required" aria-required="true"></span></a>
</span>
</label>
...
<a href="">
<?php esc_html_e( 'Login', 'youtube-showcase' ); ?>
</a>
</p>
</div>
