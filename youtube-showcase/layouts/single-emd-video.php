...
" frameborder="0" allowfullscreen referrerpolicy="strict-origin-when-cross-origin" allow="autoplay; encrypted-media; fullscreen"></iframe>
</div>
<div class="video-summary"><?php echo wp_kses_post($post->post_content); ?></div>
</div><!--container-end-->